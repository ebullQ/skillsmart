...
public class LinkedList2Test {
    ...
    public void countTesting() {
        ...
        linkedList.addInTail(new LinkedList2.Node(10));
        Assert.assertEquals(1, linkedList.count());

        linkedList.addInTail(new LinkedList2.Node(200));
        linkedList.addInTail(new LinkedList2.Node(400));
    ...
    public void removeOneTesting() {
        ...
        linkedList.addInTail(new LinkedList2.Node(10));
        linkedList.addInTail(new LinkedList2.Node(50));
        linkedList.addInTail(new LinkedList2.Node(200));
    ...
    public void findAllTesting() {
        ...
        linkedList.addInTail(new LinkedList2.Node(10));
        linkedList.addInTail(new LinkedList2.Node(50));
        linkedList.addInTail(new LinkedList2.Node(80));
        linkedList.addInTail(new LinkedList2.Node(110));
        linkedList.addInTail(new LinkedList2.Node(10));
    ...
    public void insertAfterTesting() {
        LinkedList2.Node node1 = new LinkedList2.Node(10);
        LinkedList2.Node node2 = new LinkedList2.Node(20);
        LinkedList2 linkedList = new LinkedList2();
        linkedList.addInTail(node1);
        linkedList.addInTail(node2);

        Assert.assertEquals(2, linkedList.count());
        linkedList.insertAfter(node1, new LinkedList2.Node(50));
        Assert.assertEquals(3, linkedList.count());
        Assert.assertEquals(50, linkedList.head.next.value);

        linkedList.insertAfter(null, new LinkedList2.Node(30));
        ...
        linkedList.insertAfter(node2, new LinkedList2.Node(70));
        Assert.assertEquals(5, linkedList.count());
